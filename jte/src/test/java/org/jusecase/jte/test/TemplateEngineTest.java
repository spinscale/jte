...
public class TemplateEngineTest {
    ...
    @Test
    public void helloWorld_lineBreak() {
    ...
    @Test
    public void simpleTemplateNameWithExtension() {
    ...
    @Test
    public void braceInJavaStringWithEscapedQuote() {
        model.hello = "\":-)";
        givenTemplate("@if(\"\\\":-)\".equals(model.hello))this is a smiley@endif");
        thenOutputIs("this is a smiley");
    }
    ...
    @Test
    public void tagWithGenericParam() {
    ...
    @Test
    public void tagWithMethodCallForParam() {
        givenTag("card", "@param java.lang.String firstParam\n" +
                "@param int secondParam\n" +
                "One: ${firstParam}, two: ${secondParam}");
    ...
    @Test
    public void tagWithNamedParamString() {
        givenTag("named", "@param int one\n" +
                "@param int two\n" +
                "@param String three\n" +
                "${one}, ${two}, ${three}");
    ...
    @Test
    public void tagWithNamedParam_ternary() {
        givenTag("named", "@param int one\n" +
                "@param int two\n" +
                "${one}, ${two}");
    ...
    @Test
    public void tagWithDefaultParam() {
    ...
    @Test
    public void tagWithDefaultParam_firstSet() {
        givenTag("named", "@param int one = 1\n" +
                "@param int two = 2\n" +
                "${one}, ${two}");
    ...
    @Test
    public void tagWithDefaultParam_secondSet() {
        givenTag("named", "@param int one = 1\n" +
                "@param int two = 2\n" +
                "${one}, ${two}");
    ...
    @Test
    public void layout() {
        givenLayout("main", "@param org.jusecase.jte.test.TemplateEngineTest.Model model\n" +
                "\n" +
                "<body>\n" +
    ...
    @Test
    public void layoutWithNamedParams() {
        givenLayout("main",
                "@param int status = 5\n" +
    ...
    public void enumCheck() {
        givenRawTemplate(
                "@import org.jusecase.jte.test.TemplateEngineTest.Model\n" +
                        "@import org.jusecase.jte.test.TemplateEngineTest.ModelType\n" +
                        "@param Model model\n" +
    ...
    @Test
    public void snakeCaseCanBeCompiled() {
    ...
    @Test
    public void npe_nullSafe_elseif() {
        templateEngine.setNullSafeTemplateCode(true);
        model = null;
    ...
    @Test
    public void npe_nullSafe_output() {
        templateEngine.setNullSafeTemplateCode(true);
        model = null;
    ...
    @Test
    public void npe_nullSafe_output_int() {
        templateEngine.setNullSafeTemplateCode(true);
        model = null;
    ...
    @Test
    public void npe_nullSafe_output_object() {
        templateEngine.setNullSafeTemplateCode(true);
        model = null;
    ...
    @Test
    public void npe_nullSafe_unsafeOutput() {
        templateEngine.setNullSafeTemplateCode(true);
        model = null;
    ...
    @Test
    public void npe_internal_stillThrown() {
        templateEngine.setNullSafeTemplateCode(true);
    ...
    @Test
    public void npe_statement_notNull() {
        templateEngine.setNullSafeTemplateCode(true);
        givenTemplate("!{var x = model.hello.length()}${x}");
        thenOutputIs("5");
    }
    ...
    @Test
    public void exceptionLineNumber1() {
        givenRawTemplate(
                "@import org.jusecase.jte.test.TemplateEngineTest.Model\n" +
                "\n" +
                "@param org.jusecase.jte.test.TemplateEngineTest.Model model\n" +
                "\n" +
                "${model.getThatThrows()}\n"
        );
    ...
    @Test
    public void exceptionLineNumber2() {
        givenRawTemplate(
                "@import org.jusecase.jte.test.TemplateEngineTest.Model\n" +
                        "\n\n\n" +
                        "@param org.jusecase.jte.test.TemplateEngineTest.Model model\n" +
    ...
    @Test
    public void exceptionLineNumber3() {
        givenRawTemplate(
                "@import org.jusecase.jte.test.TemplateEngineTest.Model\n" +
                        "\n" +
                        "@param org.jusecase.jte.test.TemplateEngineTest.Model model\n" +
    ...
    @Test
    public void exceptionLineNumber4() {
        givenRawTemplate(
                "@import org.jusecase.jte.test.TemplateEngineTest.Model\n" +
                        "\n" +
                        "@param org.jusecase.jte.test.TemplateEngineTest.Model model\n" +
    ...
    @Test
    public void exceptionLineNumber5() {
        givenTag("model", "@param org.jusecase.jte.test.TemplateEngineTest.Model model\n" +
                "@param int i = 0\n" +
                "i is: ${i}\n" +
                "${model.getThatThrows()}");
    ...
    @Test
    public void compileError0() {
        thenRenderingFailsWithException()
            .hasMessage("Template not found: test/template.jte");
    }

    @Test
    public void compileError1() {
        givenTemplate("@tag.model(model)");
        thenRenderingFailsWithException()
    ...
    @Test
    public void compileError4() {
        givenTag("test", "@param org.jusecase.jte.test.TemplateEngineTest.Model model\nThis will not compile!\n${model.helloUnknown}\n!!");
    ...
    private void givenTemplate(String template) {
        template = "@param org.jusecase.jte.test.TemplateEngineTest.Model model\n" + template;
