...
public class TemplateEngineTest {
    ...
    @Test
    void layout() {
        givenLayout("main", "@param model:org.jusecase.kte.TemplateEngineTest.Model\n" +
                "\n" +
                "<body>\n" +
    ...
    void enumCheck() {
        givenRawTemplate(
                "@import org.jusecase.kte.TemplateEngineTest.Model\n" +
                        "@import org.jusecase.kte.TemplateEngineTest.ModelType\n" +
                        "@param model:Model\n" +
    ...
    private void givenTemplate(String template) {
        template = "@param model:org.jusecase.kte.TemplateEngineTest.Model\n" + template;
